      ...
      .state('home', {
        ...
        resolve: {
          regionData: function($http){
            return $http.get('http://127.0.0.1:8000/mgmt/api/biz/regioncount').then(function(res){
      ...
      .state('region', {
        ...
        resolve: {
          region: function($http, $stateParams){
            return $http.get('http://127.0.0.1:8000/mgmt/api/biz/region/' + $stateParams.region).then(function(res){
              console.log('OUTPUT:');
