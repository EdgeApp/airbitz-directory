...
urlpatterns = patterns('',
    ...
    url(r'^bitcoin-wallet-api-library/$', 'management.views.page_developer_api_library', name='page_bitcoin_wallet_api_library'),
    url(r'^bitcoin-wallet-client-server-architecture/$', 'management.views.page_bitcoin_wallet_client_server_architecture', name='page_bitcoin_wallet_client_server_architecture'),
    url(r'^bitcoin-wallet-core-white-paper/$', 'management.views.page_bitcoin_wallet_core_white_paper', name='page_bitcoin_wallet_core_white_paper'),
    url(r'^bitcoin-wallet-data-model/$', 'management.views.page_bitcoin_wallet_data_model', name='page_bitcoin_wallet_data_model'),
    url(r'^bitcoin-wallet-data-sync-architecture/$', 'management.views.page_bitcoin_wallet_data_sync_architecture', name='page_bitcoin_wallet_data_sync_architecture'),
