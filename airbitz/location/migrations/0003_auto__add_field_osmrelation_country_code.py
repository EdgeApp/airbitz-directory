...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OsmRelation.country_code'
        db.add_column(u'location_osmrelation', 'country_code',
                      self.gf('django.db.models.fields.CharField')(default='US', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OsmRelation.country_code'
        db.delete_column(u'location_osmrelation', 'country_code')
