...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OsmRelation'
        db.create_table(u'location_osmrelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('osm_id', self.gf('django.db.models.fields.BigIntegerField')()),
            ('admin_level', self.gf('django.db.models.fields.SmallIntegerField')()),
        ...
        db.send_create_signal(u'location', ['OsmRelation'])


    def backwards(self, orm):
        # Deleting model 'OsmRelation'
        db.delete_table(u'location_osmrelation')
