...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.published'
        db.add_column(u'directory_business', 'published',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.published'
        db.delete_column(u'directory_business', 'published')
