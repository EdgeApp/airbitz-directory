...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.contact1_email'
        db.add_column(u'directory_business', 'contact1_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)

        # Adding field 'Business.contact2_email'
        db.add_column(u'directory_business', 'contact2_email',
                      self.gf('django.db.models.fields.EmailField')(default='', max_length=75, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.contact1_email'
        db.delete_column(u'directory_business', 'contact1_email')

        # Deleting field 'Business.contact2_email'
        db.delete_column(u'directory_business', 'contact2_email')
