...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.drop_column(u'directory_business', 'has_bitcoin_discount')
        db.add_column(u'directory_business', 'has_bitcoin_discount', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=5, decimal_places=3))

    def backwards(self, orm):
        db.drop_column(u'directory_business', 'has_bitcoin_discount')
        db.add_column(u'directory_business', 'has_bitcoin_discount', self.gf('django.db.models.fields.BooleanField')(default=False))
