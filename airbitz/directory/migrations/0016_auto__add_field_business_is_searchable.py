...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.is_searchable'
        db.add_column(u'directory_business', 'is_searchable',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.is_searchable'
        db.delete_column(u'directory_business', 'is_searchable')
