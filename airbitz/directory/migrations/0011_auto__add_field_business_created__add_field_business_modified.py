...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.created'
        db.add_column(u'directory_business', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime.utcnow(), blank=True),
                      keep_default=False)

        # Adding field 'Business.modified'
        db.add_column(u'directory_business', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime.utcnow(), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.created'
        db.delete_column(u'directory_business', 'created')

        # Deleting field 'Business.modified'
        db.delete_column(u'directory_business', 'modified')
