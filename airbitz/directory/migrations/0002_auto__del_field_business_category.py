...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Business.category'
        db.delete_column(u'directory_business', 'category_id')

        # Adding M2M table for field categories on 'Business'
        m2m_table_name = db.shorten_name(u'directory_business_categories')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('business', models.ForeignKey(orm[u'directory.business'], null=False)),
    ...
    def backwards(self, orm):
        # Adding field 'Business.category'
        db.add_column(u'directory_business', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['directory.Category'], null=True),
                      keep_default=False)

        # Removing M2M table for field categories on 'Business'
        db.delete_table(db.shorten_name(u'directory_business_categories'))
