...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BusinessHours.hourStart'
        db.alter_column(u'directory_businesshours', 'hourStart', self.gf('django.db.models.fields.TimeField')(null=True))

        # Changing field 'BusinessHours.hourEnd'
        db.alter_column(u'directory_businesshours', 'hourEnd', self.gf('django.db.models.fields.TimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'BusinessHours.hourStart'
        db.alter_column(u'directory_businesshours', 'hourStart', self.gf('django.db.models.fields.TimeField')(default=None))

        # Changing field 'BusinessHours.hourEnd'
        db.alter_column(u'directory_businesshours', 'hourEnd', self.gf('django.db.models.fields.TimeField')(default=None))
