...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.last_check_in'
        db.add_column(u'directory_business', 'last_check_in',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.last_check_in'
        db.delete_column(u'directory_business', 'last_check_in')
