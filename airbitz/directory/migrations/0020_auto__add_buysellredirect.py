...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BuySellRedirect'
        db.create_table(u'directory_buysellredirect', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=2000, null=True, blank=True)),
            ('currency_code', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'directory', ['BuySellRedirect'])


    def backwards(self, orm):
        # Deleting model 'BuySellRedirect'
        db.delete_table(u'directory_buysellredirect')
    ...
    models = {
        ...
        u'directory.buysellredirect': {
            'Meta': {'object_name': 'BuySellRedirect'},
            'currency_code': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
