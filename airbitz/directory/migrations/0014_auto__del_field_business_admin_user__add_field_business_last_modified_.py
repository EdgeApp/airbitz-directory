...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Business.last_modified_by'
        db.add_column(u'directory_business', 'last_modified_by',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Business.last_modified_by'
        db.delete_column(u'directory_business', 'last_modified_by')
