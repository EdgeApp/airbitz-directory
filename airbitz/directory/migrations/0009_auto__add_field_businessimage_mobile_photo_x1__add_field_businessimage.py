...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BusinessImage.mobile_photo_x1'
        db.add_column(u'directory_businessimage', 'mobile_photo_x1',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'BusinessImage.mobile_photo_y1'
        db.add_column(u'directory_businessimage', 'mobile_photo_y1',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'BusinessImage.mobile_photo_x2'
        db.add_column(u'directory_businessimage', 'mobile_photo_x2',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'BusinessImage.mobile_photo_y2'
        db.add_column(u'directory_businessimage', 'mobile_photo_y2',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'BusinessImage.web_photo_x1'
        db.add_column(u'directory_businessimage', 'web_photo_x1',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'BusinessImage.web_photo_y1'
        db.add_column(u'directory_businessimage', 'web_photo_y1',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'BusinessImage.web_photo_x2'
        db.add_column(u'directory_businessimage', 'web_photo_x2',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'BusinessImage.web_photo_y2'
        db.add_column(u'directory_businessimage', 'web_photo_y2',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BusinessImage.mobile_photo_x1'
        db.delete_column(u'directory_businessimage', 'mobile_photo_x1')

        # Deleting field 'BusinessImage.mobile_photo_y1'
        db.delete_column(u'directory_businessimage', 'mobile_photo_y1')

        # Deleting field 'BusinessImage.mobile_photo_x2'
        db.delete_column(u'directory_businessimage', 'mobile_photo_x2')

        # Deleting field 'BusinessImage.mobile_photo_y2'
        db.delete_column(u'directory_businessimage', 'mobile_photo_y2')

        # Deleting field 'BusinessImage.web_photo_x1'
        db.delete_column(u'directory_businessimage', 'web_photo_x1')

        # Deleting field 'BusinessImage.web_photo_y1'
        db.delete_column(u'directory_businessimage', 'web_photo_y1')

        # Deleting field 'BusinessImage.web_photo_x2'
        db.delete_column(u'directory_businessimage', 'web_photo_x2')

        # Deleting field 'BusinessImage.web_photo_y2'
        db.delete_column(u'directory_businessimage', 'web_photo_y2')
    ...
    models = {
        ...
        u'directory.businessimage': {
            ...
            'mobile_photo_x1': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'mobile_photo_x2': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'mobile_photo_y1': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'mobile_photo_y2': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            ...
            'web_photo_x1': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'web_photo_x2': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'web_photo_y1': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
            'web_photo_y2': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True'}),
