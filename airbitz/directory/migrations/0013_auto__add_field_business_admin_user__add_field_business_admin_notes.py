...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Business.admin_user'
        db.add_column(u'directory_business', 'admin_user',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Business.admin_notes'
        db.add_column(u'directory_business', 'admin_notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Business.admin_user'
        db.delete_column(u'directory_business', 'admin_user')

        # Deleting field 'Business.admin_notes'
        db.delete_column(u'directory_business', 'admin_notes')
    ...
    models = {
        u'directory.business': {
            ...
            'admin_user': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
