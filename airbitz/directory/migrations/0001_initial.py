...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'directory_business', (
            ...
            ('neighborhood', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('admin3_name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('admin2_name', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('admin1_code', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
