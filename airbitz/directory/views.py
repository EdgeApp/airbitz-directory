...
ACTIVE_REGIONS = {
    ...
    'US-NH': {'name': 'New Hampshire',
              'search': 'New Hapshire, USA'},
    'US-MA': {'name': 'Massachusetts',
              'search': 'Massachusetts, USA'},
    'US-VT': {'name': 'Vermont',
              'search': 'Vermont, USA'},
    'US-PA': {'name': 'Pennsylvania',
              'search': 'Pennsylvania, USA'},
    'US-CT': {'name': 'Connecticut',
              'search': 'Connecticut, USA'},
    'US-DE': {'name': 'Delaware',
              'search': 'Delaware, USA'},
    'US-MD': {'name': 'Maryland',
              'search': 'Maryland, USA'},
    'US-WA': {'name': 'Washington',
              'search': 'Washington, USA'},
    'US-OR': {'name': 'Oregon',
              'search': 'Oregon, USA'},
    'US-AK': {'name': 'Alaska',
              'search': 'Alaska, USA'},
    ...
    'US-NM': {'name': 'New Mexico',
              'search': 'New Mexico, USA'},
    'US-MI': {'name': 'Michigan',
              'search': 'Michigan, USA'},
    'US-MN': {'name': 'Minnesota',
              'search': 'Minnesota, USA'},
    'US-DC': {'name': 'Washington DC',
              'search': 'Washington, DC, USA'},
    'US-IN': {'name': 'Indiana',
              'search': 'Indiana, USA'},
    'US-IA': {'name': 'Iowa',
              'search': 'Iowa, USA'},
